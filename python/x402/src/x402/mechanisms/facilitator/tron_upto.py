...
class UptoTronFacilitatorMechanism(FacilitatorMechanism):
    ...
    async def _settle_payment_only(
        ...
        # Call payment_permit.permitTransferFrom with zero callback
        return await self._signer.write_contract(
            ...
            args=[
                ...
                permit.buyer,
                signature,
                "T0000000000000000000000000000000",  # callbackTarget = 0
                "0x" + "00" * 32,  # callbackHash = 0
                "0x",  # callbackData = empty
            ],
        )
